...
local euro_tests = {
   ...
   { "%n", 123, "E123" },
   { "%n", 123456, "E123.456" },
   { "%n", 1234567, "E1.234.567" },
   { "%n", 12345678, "E12.345.678" },
   { "%n", -123, "E-123" },
   { "%n", -123456, "E-123.456" },
   { "%n", -1234567, "E-1.234.567" },
   { "%n", -12345678, "E-12.345.678" },
   { "%n", 123.25, "E123,25" },
   { "%n", 123456.25, "E123.456,25" },
   { "%n", 1234567.25, "E1.234.567,25" },
   { "%n", 12345678.25, "E12.345.678,25" },
   { "%n", -123.25, "E-123,25" },
   { "%n", -123456.25, "E-123.456,25" },
   { "%n", -1234567.25, "E-1.234.567,25" },
   { "%n", -12345678.25, "E-12.345.678,25" },
   { "%+n", -123.25, "E-123,25" },
   { "%+n", -123456.25, "E-123.456,25" },
   { "%+n", -1234567.25, "E-1.234.567,25" },
   { "%+n", -12345678.25, "E-12.345.678,25" },
   ...
   { "%!#6n", 123, "    123" },
   { "%#6n", 123456, "E123.456" },
   { "%#6n", 1234567, "E1.234.567" },
   { "%#8n", 123456, "E   123.456" },
   { "%#8n", 1234567, "E 1.234.567" },
   { "%(#8n", 123456, "E   123.456 " },
   { "%(#8n", -123456, "E  (123.456)" },
   { "%n", 12345678, "E12.345.678" },
